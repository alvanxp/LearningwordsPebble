...
static void init() {
  ...
  window_set_background_color(window, GColorBlack);
	...
	// 1st line layers
	line1.currentLayer = text_layer_create(GRect(0, 1, 144, 50));
	line1.nextLayer = text_layer_create(GRect(144, 1, 144, 50));
	...
	// 3rd layers
	line3.currentLayer = text_layer_create(GRect(0, 68, 144, 50));
